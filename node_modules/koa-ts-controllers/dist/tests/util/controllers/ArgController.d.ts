...
export declare class ArgController {
    twoParams(params: any, id: any): Promise<{
        params: any;
        id: any;
    }>;
    ...
    cookie(cookie: any): Promise<any>;
    cookieSingle(cookie: string): Promise<string>;
    cookieSingleNonExist(cookie: string): Promise<string>;
